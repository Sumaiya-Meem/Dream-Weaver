...
const SelectedServiceCard = ({selectService}) => {
    ...
    return (
        <div >
            <div className="card max-w-[380px] flex justify-center items-center bg-base-100 shadow-xl">
                ...
                <div className="card-body items-center text-center ">
                    ...
                    <p className="text-[#333333] w-[250px] md:w-[600px] mx-auto text-justify">{description}</p>
