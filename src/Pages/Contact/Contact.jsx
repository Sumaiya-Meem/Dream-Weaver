...
const Contact = () => {
    return (
        <div>
            <div className="card w-[600px] min-h-[400px] mx-auto card-side flex flex-col md:flex-row-reverse bg-gray-100 shadow-xl">
      ...
      <form className="">
        ...
        <textarea className="mt-4 p-2" placeholder="Your Message" rows="5" cols="47"></textarea>
